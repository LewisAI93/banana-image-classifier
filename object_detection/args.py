...
def get_args():
    ...
    parser.add_argument('--lr', type=float, default=1e-5) # learning rate, adjust for learning curve
    parser.add_argument('--wd', type=float, default=5e-4) # weight decay. Other options: 1e-5 or 1e-7
